 ...
 *  @generated
 */
package service.chunyu.demo.rpc_proxy;
...
public class RpcException extends TException implements org.apache.thrift.TBase<RpcException, RpcException._Fields>, java.io.Serializable, Cloneable, Comparable<RpcException> {
  ...
  static {
    schemes.put(StandardScheme.class, new RpcExceptionStandardSchemeFactory());
    schemes.put(TupleScheme.class, new RpcExceptionTupleSchemeFactory());
  }
  ...
  public RpcException setMsg(String msg) {
    this.msg = msg;
    return this;
  }
  ...
  private static class RpcExceptionStandardSchemeFactory implements SchemeFactory {
    public RpcExceptionStandardScheme getScheme() {
      return new RpcExceptionStandardScheme();
    }
  }

  private static class RpcExceptionStandardScheme extends StandardScheme<RpcException> {
  ...
  private static class RpcExceptionTupleSchemeFactory implements SchemeFactory {
    public RpcExceptionTupleScheme getScheme() {
      return new RpcExceptionTupleScheme();
    }
  }

  private static class RpcExceptionTupleScheme extends TupleScheme<RpcException> {
